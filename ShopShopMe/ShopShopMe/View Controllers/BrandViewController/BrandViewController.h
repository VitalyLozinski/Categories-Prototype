...
@interface BrandViewController : UIViewController <BottomSelectViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
